...
API ドキュメントは[こちら](https://rese-api-document.netlify.app/)
...
Google アカウントを作成し、
[こちら](https://support.google.com/accounts/answer/185839?co=GENIE.Platform%3DDesktop&hl=ja&authuser=1)からまず 2 段階認証プロセスを有効にします。
...
アプリパスワードが表示されるのでメモし、下記 MAIL_PASSWORD=欄に貼り付けます。
...
```
$ curl http://127.0.0.1:8000/api/restaurants/1
```
